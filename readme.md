...
[![sampctl](https://shields.southcla.ws/badge/sampctl-y_areas-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Visual/y_areas)
...
```bash
sampctl package install YSI-Visual/y_areas
```
...
* [Quick Start](YSI-Visual/y_areas/quick-start.md) - One very simple example of getting started with this library.
* [Features](YSI-Visual/y_areas/features.md) - More features and examples.
* [FAQs](YSI-Visual/y_areas/faqs.md) - Frequently Asked Questions, including errors and solutions.
* [API](YSI-Visual/y_areas/api.md) - Full list of all functions and their meaning.
* [Internal](YSI-Visual/y_areas/internal.md) - Internal developer documentation for the system.
